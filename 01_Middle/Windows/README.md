...
- [2. コマンドプロンプト(cmd)](#2-コマンドプロンプトcmd)
  - [2.1. 設定](#21-設定)
  - [2.2. 変数](#22-変数)
  - [2.3. 【curl】 サーバへデータ転送を行う](#23-curl-サーバへデータ転送を行う)
  - [2.4. 【dir】 配下のファイルを一覧で取得](#24-dir-配下のファイルを一覧で取得)
  - [2.5. 【doskey】 マクロ（エイリアス）の登録](#25-doskey-マクロエイリアスの登録)
  - [2.6. 【fc】 ファイルの比較を行う](#26-fc-ファイルの比較を行う)
  - [2.7. 【find】 ファイル内の文字列を検索する](#27-find-ファイル内の文字列を検索する)
  - [2.8. 【findstr】 findの多機能版](#28-findstr-findの多機能版)
  - [2.9. 【net】 ネットワーク関係の設定や現在の状態を表示する](#29-net-ネットワーク関係の設定や現在の状態を表示する)
  - [2.10. 【netsh】 ネットワーク関係のパラメータの設定](#210-netsh-ネットワーク関係のパラメータの設定)
  - [2.11. 【pushd／popd】 カレントディレクトリを変更](#211-pushdpopd-カレントディレクトリを変更)
  - [2.12. 【ssh】 SSHで接続（TeraTermの代替）](#212-ssh-sshで接続teratermの代替)
  - [2.13. 【tree】 配下のファイルをツリー階層で取得](#213-tree-配下のファイルをツリー階層で取得)
  - [2.14. 【where】 検索パターンに一致するファイルリストを表示](#214-where-検索パターンに一致するファイルリストを表示)
...
### 2.9. 【net】 ネットワーク関係の設定や現在の状態を表示する
...
### 2.14. 【where】 検索パターンに一致するファイルリストを表示
