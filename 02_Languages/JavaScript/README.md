...
<!-- TOC -->
- [1. 概要](#1-概要)
- [2. 変数宣言／データ型](#2-変数宣言データ型)
  - [2.1. 変数宣言](#21-変数宣言)
  - [2.2. データ型](#22-データ型)
- [3. 関数／クラス](#3-関数クラス)
  - [3.1. 関数の定義](#31-関数の定義)
  - [3.2. 関数のさまざまな引数](#32-関数のさまざまな引数)
  - [3.3. クラスの定義](#33-クラスの定義)
- [4. その他構文](#4-その他構文)
  - [4.1. ラッパーオブジェクト](#41-ラッパーオブジェクト)
  - [4.2. 等価／厳密等価](#42-等価厳密等価)
  - [4.3. 分割代入／スプレッド構文](#43-分割代入スプレッド構文)
  - [4.4. 繰り返し処理](#44-繰り返し処理)
  - [4.5. オブジェクトのマージとコピー](#45-オブジェクトのマージとコピー)
  - [4.6. プロトタイプ](#46-プロトタイプ)
  - [4.7. 同期／非同期とプロミス](#47-同期非同期とプロミス)
- [5. Node.js](#5-nodejs)
  - [5.1. 概要](#51-概要)
  - [5.2. npm／yarn](#52-npmyarn)
  - [5.3. package.jsonの記載方法](#53-packagejsonの記載方法)
- [6. React](#6-react)
  - [6.1. Reactの歴史](#61-reactの歴史)
  - [6.2. Reactの特徴](#62-reactの特徴)
  - [6.3. 他のフレームワークとの比較](#63-他のフレームワークとの比較)
  - [6.4. create-react-appによるひな型作成](#64-create-react-appによるひな型作成)
  - [6.5. Virtual DOM（仮想DOM）](#65-virtual-dom仮想dom)
  - [6.6. Reactの仕組み](#66-reactの仕組み)
  - [6.7. 関数型コンポーネント](#67-関数型コンポーネント)
  - [6.8. クラス型コンポーネント](#68-クラス型コンポーネント)
  - [6.9. その他](#69-その他)
- [7. Web技術トレンド](#7-web技術トレンド)
  - [7.1. CSR(Client Side Rendering)](#71-csrclient-side-rendering)
  - [7.2. SPA(Single Page Application)](#72-spasingle-page-application)
  - [7.3. SSR(Server Side Rendering)](#73-ssrserver-side-rendering)
  - [7.4. SSG(Static Site Generator)](#74-ssgstatic-site-generator)
---
<br>
<!-- /TOC -->
...
###  7.2. SPA(Single Page Application)
CSRと同じ意味
